...
theorem STAmount.operator_sub_repr_native (v1 v2 result : STAmount) (mode : rounding_mode)
...
theorem STAmount.operator_sub_repr_mpt (v1 v2 result : STAmount) (mode : rounding_mode)
...
theorem STAmount.operator_sub_repr_iou (v1 v2 result : STAmount) (iss : Issue)
  ...
  STAmount.operator_sub_repr_iou_proof v1 v2 result iss hv1 hv2 h_xrp hc1 hc2 h_truth_ne hok hresult

/-- **IOU subtraction lands within `2` ULP of `v1 − v2` (directed modes)** -/
theorem STAmount.operator_sub_repr_iou_directed (v1 v2 result : STAmount) (iss : Issue)
    (mode : rounding_mode)
    (hv1 : v1.mAsset = .issue iss) (hv2 : v2.mAsset = .issue iss) (h_xrp : iss.isXRP = false)
    (hc1 : v1.IOUCanonical) (hc2 : v2.IOUCanonical)
    (h_truth_ne : v1.toRat - v2.toRat ≠ 0)
  ...
  STAmount.operator_sub_repr_iou_directed_proof v1 v2 result iss mode hv1 hv2 h_xrp hc1 hc2
