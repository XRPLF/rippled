...
theorem operator_mul_algorithmic_facts_to_nearest (x y result : Number)
  ...
  have h_inv := doRoundUp_output_invariants_to_nearest_upTo_maxRepUp g zn zm ze' hzm_ge hzm_le_maxRep "Number::multiplication overflow" res h_rup hres_mant_ne
  ...
  have h_rup_pos : g.doRoundUp false zm ze' largeRange.min largeRange.max .to_nearest "Number::multiplication overflow" = .ok res_pos :=
    doRoundUp_false_from_ok g zn zm ze' .to_nearest "Number::multiplication overflow" res h_rup
