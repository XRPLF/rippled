...
/-- `Rounds`-shaped restatement of `operator_mul_rounding_bound_downward`. -/
...
where the relative error exceeds `9/(2^63+2)`, proving 10 is the optimal integer numerator. -/
