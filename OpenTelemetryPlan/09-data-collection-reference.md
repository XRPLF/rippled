...
| `parent_close_time_ripple_epoch_s` | int64   | `consensus.accept.apply`                                                                                               | Parent ledger's close time (Ripple epoch seconds)                     |
| `close_time_self_ripple_epoch_s`   | int64   | `consensus.accept.apply`                                                                                               | This node's proposed close time (Ripple epoch seconds)                |
...
| `previous_close_agree`             | bool    | `consensus.phase.open`                                                                                                 | Whether the prior ledger's close time was agreed                      |
| `peer_positions_at_open`           | int64   | `consensus.phase.open`                                                                                                 | Positions held after buffered proposals are replayed                  |
| `early_close_triggered`            | bool    | `consensus.phase.open`                                                                                                 | Round skipped the timer because peers had already closed              |
