...
| `parent_close_time_ripple_epoch_s` | int64   | `consensus.accept.apply`                                                                                               | Parent ledger's close time (XRPL epoch seconds)                       |
| `close_time_self_ripple_epoch_s`   | int64   | `consensus.accept.apply`                                                                                               | This node's proposed close time (XRPL epoch seconds)                  |
