...
- `book_offers`: Null `taker_pays` / `taker_gets` values are rejected immediately with a "not object" error instead of a misleading missing-field message. [#6836](https://github.com/XRPLF/rippled/pull/6836)
