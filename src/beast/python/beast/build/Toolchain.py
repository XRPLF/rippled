...
def where_is(env, filename):
    # Use Scons's WhereIs if available, otherwise the replacement.
...
class Toolchain(object):
    ...
    def detect(self, scons):
        ...
        """
        return (self._specific(scons) or
                self._generic(scons) or
                self._default(scons))

    def _specific(self, scons):
