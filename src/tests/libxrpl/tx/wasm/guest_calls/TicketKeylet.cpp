...
// ticket_id — an account region and a four-byte `seq` region in, a keylet region out.
struct TicketKeyletGuest : GuestCallTest
{
    ...
    static constexpr std::uint32_t kSeqValue = 0x6f708192;
