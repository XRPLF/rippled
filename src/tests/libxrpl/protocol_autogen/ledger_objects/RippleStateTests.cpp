...
TEST(RippleStateTests, BuilderFromSleRoundTrip)
{
    ...
    SLE sle{RippleState::entryType, index};

    sle[sfBalance] = balanceValue;
    sle[sfLowLimit] = lowLimitValue;
    sle[sfHighLimit] = highLimitValue;
    sle[sfPreviousTxnID] = previousTxnIDValue;
    sle[sfPreviousTxnLgrSeq] = previousTxnLgrSeqValue;
    sle[sfLowNode] = lowNodeValue;
    sle[sfLowQualityIn] = lowQualityInValue;
    sle[sfLowQualityOut] = lowQualityOutValue;
    sle[sfHighNode] = highNodeValue;
    sle[sfHighQualityIn] = highQualityInValue;
    sle[sfHighQualityOut] = highQualityOutValue;
