...
#include <xrpl/protocol_autogen/ledger_objects/XChainOwnedCreateAccountClaimID.h>
...
TEST(XChainOwnedCreateAccountClaimIDTests, BuilderFromSleRoundTrip)
{
    ...
    SLE sle{XChainOwnedCreateAccountClaimID::entryType, index};
...
TEST(XChainOwnedCreateAccountClaimIDTests, WrapperThrowsOnWrongEntryType)
{
    ...
    EXPECT_THROW(XChainOwnedCreateAccountClaimID{wrongEntry.object()}, std::runtime_error);
}
...
TEST(XChainOwnedCreateAccountClaimIDTests, BuilderThrowsOnWrongEntryType)
{
    ...
    EXPECT_THROW(XChainOwnedCreateAccountClaimIDBuilder{wrongEntry.object()}, std::runtime_error);
}
