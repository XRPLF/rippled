...
TEST(FeeSettingsTests, BuilderFromSleRoundTrip)
{
    ...
    SLE sle{FeeSettings::entryType, index};

    sle[sfBaseFee] = baseFeeValue;
    sle[sfReferenceFeeUnits] = referenceFeeUnitsValue;
    sle[sfReserveBase] = reserveBaseValue;
    sle[sfReserveIncrement] = reserveIncrementValue;
    sle[sfBaseFeeDrops] = baseFeeDropsValue;
    sle[sfReserveBaseDrops] = reserveBaseDropsValue;
    sle[sfReserveIncrementDrops] = reserveIncrementDropsValue;
