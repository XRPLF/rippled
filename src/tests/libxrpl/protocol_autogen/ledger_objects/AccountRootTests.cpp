...
TEST(AccountRootTests, BuilderFromSleRoundTrip)
{
    ...
    SLE sle{AccountRoot::entryType, index};

    sle[sfAccount] = accountValue;
    sle[sfSequence] = sequenceValue;
    sle[sfBalance] = balanceValue;
    sle[sfOwnerCount] = ownerCountValue;
    sle[sfPreviousTxnID] = previousTxnIDValue;
    sle[sfPreviousTxnLgrSeq] = previousTxnLgrSeqValue;
    sle[sfAccountTxnID] = accountTxnIDValue;
    sle[sfRegularKey] = regularKeyValue;
    sle[sfEmailHash] = emailHashValue;
    sle[sfWalletLocator] = walletLocatorValue;
    sle[sfWalletSize] = walletSizeValue;
    sle[sfMessageKey] = messageKeyValue;
    sle[sfTransferRate] = transferRateValue;
    sle[sfDomain] = domainValue;
    sle[sfTickSize] = tickSizeValue;
    sle[sfTicketCount] = ticketCountValue;
    sle[sfNFTokenMinter] = nFTokenMinterValue;
    sle[sfMintedNFTokens] = mintedNFTokensValue;
    sle[sfBurnedNFTokens] = burnedNFTokensValue;
    sle[sfFirstNFTokenSequence] = firstNFTokenSequenceValue;
    sle[sfAMMID] = aMMIDValue;
    sle[sfVaultID] = vaultIDValue;
