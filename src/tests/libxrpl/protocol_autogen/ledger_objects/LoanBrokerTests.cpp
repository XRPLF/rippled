...
TEST(LoanBrokerTests, BuilderFromSleRoundTrip)
{
    ...
    SLE sle{LoanBroker::entryType, index};
    ...
    sle[sfVaultNode] = vaultNodeValue;
    ...
    sle[sfManagementFeeRate] = managementFeeRateValue;
    sle[sfOwnerCount] = ownerCountValue;
    sle[sfDebtTotal] = debtTotalValue;
    sle[sfDebtMaximum] = debtMaximumValue;
    sle[sfCoverAvailable] = coverAvailableValue;
    sle[sfCoverRateMinimum] = coverRateMinimumValue;
    sle[sfCoverRateLiquidation] = coverRateLiquidationValue;
