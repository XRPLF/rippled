...
TEST(MPTokenIssuanceTests, BuilderFromSleRoundTrip)
{
    ...
    SLE sle{MPTokenIssuance::entryType, index};

    sle[sfIssuer] = issuerValue;
    sle[sfSequence] = sequenceValue;
    sle[sfTransferFee] = transferFeeValue;
    sle[sfOwnerNode] = ownerNodeValue;
    sle[sfAssetScale] = assetScaleValue;
    sle[sfMaximumAmount] = maximumAmountValue;
    sle[sfOutstandingAmount] = outstandingAmountValue;
    sle[sfLockedAmount] = lockedAmountValue;
    sle[sfMPTokenMetadata] = mPTokenMetadataValue;
    sle[sfPreviousTxnID] = previousTxnIDValue;
    sle[sfPreviousTxnLgrSeq] = previousTxnLgrSeqValue;
    sle[sfDomainID] = domainIDValue;
    sle[sfMutableFlags] = mutableFlagsValue;
