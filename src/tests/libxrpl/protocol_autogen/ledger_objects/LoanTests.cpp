...
#include <xrpl/protocol_autogen/ledger_objects/Loan.h>
...
TEST(LoanTests, BuilderFromSleRoundTrip)
{
    ...
    SLE sle{Loan::entryType, index};

    sle[sfPreviousTxnID] = previousTxnIDValue;
    sle[sfPreviousTxnLgrSeq] = previousTxnLgrSeqValue;
    sle[sfOwnerNode] = ownerNodeValue;
    sle[sfLoanBrokerNode] = loanBrokerNodeValue;
    sle[sfLoanBrokerID] = loanBrokerIDValue;
    sle[sfLoanSequence] = loanSequenceValue;
    sle[sfBorrower] = borrowerValue;
    sle[sfLoanOriginationFee] = loanOriginationFeeValue;
    sle[sfLoanServiceFee] = loanServiceFeeValue;
    sle[sfLatePaymentFee] = latePaymentFeeValue;
    sle[sfClosePaymentFee] = closePaymentFeeValue;
    sle[sfOverpaymentFee] = overpaymentFeeValue;
    sle[sfInterestRate] = interestRateValue;
    sle[sfLateInterestRate] = lateInterestRateValue;
    sle[sfCloseInterestRate] = closeInterestRateValue;
    sle[sfOverpaymentInterestRate] = overpaymentInterestRateValue;
    sle[sfStartDate] = startDateValue;
    sle[sfPaymentInterval] = paymentIntervalValue;
    sle[sfGracePeriod] = gracePeriodValue;
    sle[sfPreviousPaymentDueDate] = previousPaymentDueDateValue;
    sle[sfNextPaymentDueDate] = nextPaymentDueDateValue;
    sle[sfPaymentRemaining] = paymentRemainingValue;
    sle[sfPeriodicPayment] = periodicPaymentValue;
    sle[sfPrincipalOutstanding] = principalOutstandingValue;
    sle[sfTotalValueOutstanding] = totalValueOutstandingValue;
    sle[sfManagementFeeOutstanding] = managementFeeOutstandingValue;
    sle[sfLoanScale] = loanScaleValue;
...
TEST(LoanTests, WrapperThrowsOnWrongEntryType)
{
    ...
    EXPECT_THROW(Loan{wrongEntry.object()}, std::runtime_error);
}
...
TEST(LoanTests, BuilderThrowsOnWrongEntryType)
{
    ...
    EXPECT_THROW(LoanBuilder{wrongEntry.object()}, std::runtime_error);
}
