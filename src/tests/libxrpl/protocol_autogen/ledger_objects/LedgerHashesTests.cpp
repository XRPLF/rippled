...
TEST(LedgerHashesTests, BuilderFromSleRoundTrip)
{
    ...
    SLE sle{LedgerHashes::entryType, index};

    sle[sfFirstLedgerSequence] = firstLedgerSequenceValue;
    sle[sfLastLedgerSequence] = lastLedgerSequenceValue;
    sle[sfHashes] = hashesValue;
