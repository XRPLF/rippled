// Auto-generated unit tests for transaction AMMClawback
...
TEST(TransactionsAMMClawbackTests, BuilderSettersRoundTrip)
{
...
TEST(TransactionsAMMClawbackTests, BuilderFromStTxRoundTrip)
{
    // Generate a deterministic keypair for signing
    auto const [publicKey, secretKey] =
...
TEST(TransactionsAMMClawbackTests, WrapperThrowsOnWrongTxType)
{
...
TEST(TransactionsAMMClawbackTests, BuilderThrowsOnWrongTxType)
{
    // Build a valid transaction of a different type
    auto const [pk, sk] =
...
TEST(TransactionsAMMClawbackTests, OptionalFieldsReturnNullopt)
{
    // Generate a deterministic keypair for signing
    auto const [publicKey, secretKey] =
