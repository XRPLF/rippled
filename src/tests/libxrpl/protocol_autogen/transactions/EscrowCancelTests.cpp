...
#include <xrpl/protocol_autogen/transactions/EscrowCancel.h>
...
TEST(TransactionsEscrowCancelTests, BuilderSettersRoundTrip)
{
...
TEST(TransactionsEscrowCancelTests, BuilderFromStTxRoundTrip)
{
    // Generate a deterministic keypair for signing
    auto const [publicKey, secretKey] =
...
TEST(TransactionsEscrowCancelTests, WrapperThrowsOnWrongTxType)
{
...
TEST(TransactionsEscrowCancelTests, BuilderThrowsOnWrongTxType)
{
    // Build a valid transaction of a different type
    auto const [pk, sk] =
