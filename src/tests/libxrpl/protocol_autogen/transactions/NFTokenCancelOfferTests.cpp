...
TEST(TransactionsNFTokenCancelOfferTests, BuilderSettersRoundTrip)
{
    ...
    // Verify required fields
    {
        ...
        auto const actual = tx->getNFTokenOffers();
        expectEqualField(expected, actual, "sfNFTokenOffers");
    }
...
TEST(TransactionsNFTokenCancelOfferTests, BuilderFromStTxRoundTrip)
{
    ...
    NFTokenCancelOfferBuilder builderFromTx{initialTx.object()};
    ...
    {
        auto const& expected = nFTokenOffersValue;
        auto const actual = rebuiltTx->getNFTokenOffers();
        expectEqualField(expected, actual, "sfNFTokenOffers");
    }
...
TEST(TransactionsNFTokenCancelOfferTests, WrapperThrowsOnWrongTxType)
{
    ...
    EXPECT_THROW(NFTokenCancelOffer{wrongTx.object()}, std::runtime_error);
}
...
TEST(TransactionsNFTokenCancelOfferTests, BuilderThrowsOnWrongTxType)
{
    ...
    EXPECT_THROW(NFTokenCancelOfferBuilder{wrongTx.object()}, std::runtime_error);
}
