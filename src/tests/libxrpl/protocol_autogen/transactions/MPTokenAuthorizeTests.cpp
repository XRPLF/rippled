...
TEST(TransactionsMPTokenAuthorizeTests, WrapperThrowsOnWrongTxType)
{
...
TEST(TransactionsMPTokenAuthorizeTests, BuilderThrowsOnWrongTxType)
{
    // Build a valid transaction of a different type
    auto const [pk, sk] =
...
TEST(TransactionsMPTokenAuthorizeTests, OptionalFieldsReturnNullopt)
{
    // Generate a deterministic keypair for signing
    auto const [publicKey, secretKey] =
