    ...
    testDisputes()
    {
        ...
        // use yes
        {
            ...
            auto expectStalled = [this, &clog](
                ...
                expect(
                    s.find("voting "s + (ourVote ? "YES" : "NO")) != std::string::npos,
                    s,
                    __FILE__,
                    line);
                expect(
                    s.find("for "s + std::to_string(ourTime) + " rounds."s) != std::string::npos,
                    s,
                    __FILE__,
                    line);
                expect(
                    s.find("votes in "s + std::to_string(peerTime) + " rounds.") !=
                        std::string::npos,
                    s,
                    __FILE__,
                    line);
