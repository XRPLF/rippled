    ...
    std::vector<jtx::deposit::AuthorizeCredentials> const& auth)
{
    ...
    jvParams[jss::deposit_preauth][jss::authorized_credentials] = json::ValueType::ArrayValue;
    ...
    testCredentialsPayment()
    {
...

        {
            ...
            // Alice can't pay - empty credentials array
            {
                ...
                jv[sfCredentialIDs.jsonName] = json::ValueType::ArrayValue;
    ...
    testCredentialsCreation()
    {
...

        {
...

            {
                ...
                jv[sfUnauthorizeCredentials.jsonName] = json::ValueType::ArrayValue;
                env(jv, Ter(temMALFORMED));
            }
...

            {
                ...
                json::Value cred = json::ValueType::ObjectValue;
