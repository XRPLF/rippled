...
public:
    ...
    testSubmitTransactionGuards()
    {
        ...
        BEAST_EXPECT(tx->getStatus() == TransStatus::INVALID);
    ...
    testTransactionResultBranches()
    {
        ...
        BEAST_EXPECT(included->getStatus() == TransStatus::INCLUDED);
        ...
        BEAST_EXPECT(obsolete->getStatus() == TransStatus::OBSOLETE);
        ...
        BEAST_EXPECT(heldLocal->getStatus() == TransStatus::HELD);
        ...
        env.app().getJobQueue().rendezvous();
        BEAST_EXPECT(heldNetwork->getStatus() == TransStatus::HELD);
