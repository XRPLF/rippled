...
class Vault_test : public beast::unit_test::suite
{
    ...
    testPreflight()
    {
        ...
        struct CaseArgs
        {
            FeatureBitset features = testableAmendments() | featureSingleAssetVault;
        };
        ...
        testCase(
            ...
            {.features =
                 (testableAmendments() | featureSingleAssetVault) - featurePermissionedDomains});
