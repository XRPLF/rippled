...
class ConfidentialTransfer_test : public beast::unit_test::suite
{
    ...
    testClawbackPreclaim(FeatureBitset features)
    {
...

        {
            ...
            mptAlice.create({
                .flags = tfMPTCanTransfer | tfMPTCanClawback | tfMPTRequireAuth | tfMPTCanPrivacy,
            });
            mptAlice.authorize({
                .account = bob,
            });
        ...
        // no issuer key
        {
            ...
            MPTTester mptAlice(env, alice, {.holders = {bob}});
            mptAlice.create({
                .flags = tfMPTCanClawback | tfMPTCanPrivacy,
            });
            mptAlice.authorize({
                .account = bob,
            });
    ...
    testClawbackProof(FeatureBitset features)
    {
        ...
        auto setupEnv = [&](Env& env) -> MPTTester {
            ...
            mptAlice.create({
                .flags = tfMPTCanTransfer | tfMPTCanClawback | tfMPTCanPrivacy,
            });
