    ...
    class AMMClawback_test : public beast::unit_test::suite
    {
        ...
        testAMMClawbackSpecificAmount(FeatureBitset features)
        {
            ...
            // to the holder.
            {
                ...
                BEAST_EXPECT(
                    amm.expectBalances(USD(2000), XRP(1000), IOUAmount{1414213562373095, -9}));
                ...
                BEAST_EXPECT(
                    amm.expectBalances(USD(1000), XRP(500), IOUAmount{7071067811865475, -10}));
        ...
        testAMMClawbackExceedBalance(FeatureBitset features)
        {
            ...
            // balance in AMM pool.
            {
                ...
                BEAST_EXPECT(
                    env.balance(alice, EUR) == STAmount(EUR, UINT64_C(6000000000000000), -12));
            ...
            // creates the AMM pool EUR/XRP.
            {
                ...
                BEAST_EXPECT(
                    amm.expectBalances(USD(1000), XRP(2000), IOUAmount{1414213562373095, -9}));
                amm.deposit(alice, USD(1000), XRP(2000));
                BEAST_EXPECT(
                    amm.expectBalances(USD(2000), XRP(4000), IOUAmount{2828427124746190, -9}));
                amm.deposit(bob, USD(1000), XRP(2000));
                BEAST_EXPECT(
                    amm.expectBalances(USD(3000), XRP(6000), IOUAmount{4242640687119285, -9}));
                env.close();
        ...
        testAMMClawbackAll(FeatureBitset features)
        {
            ...
            // issuer. Claw back all the USD for different users.
            {
                ...
                env.require(balance(alice, EUR(1000)));
                BEAST_EXPECT(
                    env.balance(bob, USD) == STAmount(USD, UINT64_C(3000000000000000), -12));
        ...
        testAMMClawbackIssuesEachOther(FeatureBitset features)
        {
            ...
            env.close();
            BEAST_EXPECT(
                amm.expectBalances(USD(1000), EUR(2000), IOUAmount{1414213562373095, -12}));

            amm.deposit(gw2, USD(2000), EUR(4000));
            BEAST_EXPECT(
                amm.expectBalances(USD(3000), EUR(6000), IOUAmount{4242640687119285, -12}));

            amm.deposit(alice, USD(3000), EUR(6000));
            BEAST_EXPECT(
                amm.expectBalances(USD(6000), EUR(12000), IOUAmount{8485281374238570, -12}));
        ...
        testLastHolderLPTokenBalance(FeatureBitset features)
        {
            ...
            auto getLPTokenBalances = [&](auto& env, auto const& amm, auto const& account)
