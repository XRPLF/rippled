...
public:
    ...
    run() override
    {
        ...
        }
        {
            ...
            Config c;
            c.section(Sections::kVALIDATION_SEED).append(seed_);
...

        {
            ...
            Config c;
            c.section(Sections::kVALIDATION_SEED).append("badseed");
...

        {
            // validator token
            Config c;
            c.section(Sections::kVALIDATOR_TOKEN).append(tokenBlob_);
            ValidatorKeys k{c, journal};
