...
struct PayChan_test : public beast::unit_test::Suite
{
    ...
    testAccountChannelsRPC(FeatureBitset features)
    {
        ...
        }
        {
            ...
            testInvalidDestAccountParam(json::Value(json::ValueType::NullValue));
            testInvalidDestAccountParam(json::Value(json::ValueType::ObjectValue));
            testInvalidDestAccountParam(json::Value(json::ValueType::ArrayValue));
        }
        {
    ...
    testAccountChannelsRPCMarkers(FeatureBitset features)
    {
        ...
        auto testLimit = [](test::jtx::Env& env,
                            ...
                            json::Value const& marker = json::ValueType::NullValue,
        ...
        for (int limit = 1; limit < bobs.size() + 1; ++limit)
        {
            ...
            json::Value marker = json::ValueType::NullValue;
