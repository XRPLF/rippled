...
class PeerImp_test : public beast::unit_test::Suite
{
    ...
    createPeer(
        ...
        ProtocolVersion protocol = makeProtocol(2, 2))
    {
    ...
    testProtocolMessages()
    {
        ...
        std::vector<PeerFinder::Endpoint> endpoints = {
            {beast::IP::Endpoint::fromString("198.51.100.201:51235"), 2},
            {beast::IP::Endpoint::fromString("198.51.100.202:51235"), 3},
        };
    ...
    testFeatureAndMessageGuards()
    {
        ...
        auto unsupported = createPeer(env, true, false, makeProtocol(1, 0));
