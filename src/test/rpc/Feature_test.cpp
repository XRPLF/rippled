...
class Feature_test : public beast::unit_test::Suite
{
    ...
    testInvalidFeature()
    {
        ...
        testInvalidParam(json::Value(json::ValueType::NullValue));
        testInvalidParam(json::Value(json::ValueType::ObjectValue));
        testInvalidParam(json::Value(json::ValueType::ArrayValue));
