    ...
    namespace xrpl
{
    ...
    template <class TIn, class TOut>
    void TOfferStreamBase<TIn, TOut>::erase(ApplyView & view)
    {
    ...
    static STAmount accountFundsHelper(
        ReadView const& view,
        AccountID const& id,
    ...
    static IOUAmount accountFundsHelper(
        ReadView const& view,
        AccountID const& id,
    ...
    static XRPAmount accountFundsHelper(
        ReadView const& view,
        AccountID const& id,
    ...
    bool TOfferStreamBase<TIn, TOut>::shouldRmSmallIncreasedQOffer() const
    {
        static_assert(
    ...
    template <class TIn, class TOut>
    bool TOfferStreamBase<TIn, TOut>::step()
    {
    ...
    void OfferStream::permRmOffer(uint256 const& offerIndex)
    {
