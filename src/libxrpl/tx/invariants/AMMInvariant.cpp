    ...
    namespace xrpl
{
    ...
    bool ValidAMM::finalizeVote(bool enforce, beast::Journal const& j) const
    {
    ...
    bool ValidAMM::finalizeBid(bool enforce, beast::Journal const& j) const
    {
        if (ammPoolChanged_)
        {
    ...
    bool ValidAMM::finalizeCreate(
        STTx const& tx, ReadView const& view, bool enforce, beast::Journal const& j) const
    {
        if (!ammAccount_)
        {
            // LCOV_EXCL_START
    ...
    bool ValidAMM::finalizeDelete(bool enforce, TER res, beast::Journal const& j) const
    {
        if (ammAccount_)
        {
            // LCOV_EXCL_START
    ...
    bool ValidAMM::finalizeDEX(bool enforce, beast::Journal const& j) const
    {
        if (ammAccount_)
        {
            // LCOV_EXCL_START
    ...
    bool ValidAMM::generalInvariant(
        xrpl::STTx const& tx,
    ...
    bool ValidAMM::finalizeDeposit(
        xrpl::STTx const& tx, xrpl::ReadView const& view, bool enforce, beast::Journal const& j)
        const
    {
        if (!ammAccount_)
        {
    ...
    bool ValidAMM::finalizeWithdraw(
        xrpl::STTx const& tx, xrpl::ReadView const& view, bool enforce, beast::Journal const& j)
        const
    {
        if (!ammAccount_)
