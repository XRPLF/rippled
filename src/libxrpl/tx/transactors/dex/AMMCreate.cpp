...
<xrpl / ledger / helpers / AMMHelpers.h><xrpl / ledger / helpers / AMMUtils.h>
    ...
    namespace xrpl
{
    bool AMMCreate::checkExtraFeatures(PreflightContext const& ctx)
    {
    ...
    XRPAmount AMMCreate::calculateBaseFee(ReadView const& view, STTx const& tx)
    {
    ...
    static std::pair<TER, bool> applyCreate(
        ApplyContext & ctx_, Sandbox & sb, AccountID const& account_, beast::Journal j_)
    {
