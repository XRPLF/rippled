...
bool
ConfidentialMPTRecoverBalance::checkExtraFeatures(PreflightContext const& ctx)
{
...
void
ConfidentialMPTRecoverBalance::visitInvariantEntry(bool, SLE::const_ref, SLE::const_ref)
{
}
