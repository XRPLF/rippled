    ...
    int& maxCount) const
{
    ...
    while (!nodeStack.empty())
    {
        ...
        if (node->isInner())
        {
            ...
            auto inner = dynamic_cast<SHAMapInnerNode*>(node);
            for (int i = 0; i < 16; ++i)
            {
        ...
        else
        {
            ...
            auto item = dynamic_cast<SHAMapLeafNode*>(node)->peekItem();
...
SHAMap::compare(SHAMap const& otherMap, Delta& differences, int maxCount) const
{
    ...
    while (!nodeStack.empty())
    {
        ...
        {
            // two leaves
            auto ours = dynamic_cast<SHAMapLeafNode*>(ourNode);
            auto other = dynamic_cast<SHAMapLeafNode*>(otherNode);
        ...
        {
            auto ours = dynamic_cast<SHAMapInnerNode*>(ourNode);
            auto other = dynamic_cast<SHAMapLeafNode*>(otherNode);
        ...
        {
            auto ours = dynamic_cast<SHAMapLeafNode*>(ourNode);
            auto other = dynamic_cast<SHAMapInnerNode*>(otherNode);
