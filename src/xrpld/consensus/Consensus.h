...
Consensus<Adaptor>::getJson(bool full) const
{
    ...
    if (full)
    {
        ...
        {
            json::Value ppj(json::ValueType::ObjectValue);
        ...
        if (!acquired_.empty())
        {
            json::Value acq(json::ValueType::ArrayValue);
        ...
        {
            json::Value dsj(json::ValueType::ObjectValue);
        ...
        {
            json::Value ctj(json::ValueType::ObjectValue);
        ...
        if (!deadNodes_.empty())
        {
            json::Value dnj(json::ValueType::ArrayValue);
