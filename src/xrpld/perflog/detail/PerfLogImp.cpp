...
{
    json::Value rpcobj(json::ValueType::ObjectValue);
    ...
    for (auto const& proc : rpc)
    {
        ...
        json::Value p(json::ValueType::ObjectValue);
    ...
    {
        json::Value totalRpcJson(json::ValueType::ObjectValue);
    ...
    json::Value jobQueueObj(json::ValueType::ObjectValue);
    ...
    {
        json::Value totalJqJson(json::ValueType::ObjectValue);
    ...
    json::Value counters(json::ValueType::ObjectValue);
...
PerfLogImp::Counters::currentJson() const
{
    ...
    json::Value jobsArray(json::ValueType::ArrayValue);
    ...
    for (auto const& j : jobs)
    {
        if (j.first == JtInvalid)
            continue;
        json::Value jobj(json::ValueType::ObjectValue);
    ...
    json::Value methodsArray(json::ValueType::ArrayValue);
    ...
    for (auto m : methods)
    {
        json::Value methodobj(json::ValueType::ObjectValue);
    ...
    json::Value current(json::ValueType::ObjectValue);
...
PerfLogImp::report()
{
    ...
    json::Value report(json::ValueType::ObjectValue);
    ...
    report[jss::nodestore] = json::ValueType::ObjectValue;
