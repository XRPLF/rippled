...
Handler const kHANDLER_ARRAY[]{
    ...
    {.name = "path_find",
     ...
     .role = Role::USER,
     .condition = NeedsCurrentLedger},
    {.name = "ping", .valueMethod = byRef(&doPing), .role = Role::USER, .condition = NoCondition},
    {.name = "print",
    ...
    {.name = "server_state",
     ...
     .role = Role::USER,
     .condition = NoCondition},
    {.name = "sign", .valueMethod = byRef(&doSign), .role = Role::USER, .condition = NoCondition},
    {.name = "sign_for",
    ...
    {.name = "simulate",
     ...
     .role = Role::USER,
     .condition = NeedsCurrentLedger},
    {.name = "stop", .valueMethod = byRef(&doStop), .role = Role::ADMIN, .condition = NoCondition},
    {.name = "submit",
