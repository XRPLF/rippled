...
Handler const handlerArray[]{
    ...
    {"clamm_info", byRef(&doCLAMMInfo), Role::USER, NO_CONDITION},
    {"clamm_positions", byRef(&doCLAMMPositions), Role::USER, NO_CONDITION},
    {"clamm_ticks", byRef(&doCLAMMTicks), Role::USER, NO_CONDITION},
    {"clamm_quote", byRef(&doCLAMMQuote), Role::USER, NO_CONDITION},
