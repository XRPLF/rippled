...
ServerDefinitions::ServerDefinitions() : defs_{json::ValueType::ObjectValue}
{
    // populate SerializedTypeID names and values
    defs_[jss::TYPES] = json::ValueType::ObjectValue;
    ...
    defs_[jss::LEDGER_ENTRY_TYPES] = json::ValueType::ObjectValue;
    ...
    defs_[jss::FIELDS] = json::ValueType::ArrayValue;

    uint32_t i = 0;

    {
        json::Value a = json::ValueType::ArrayValue;
        a[0U] = "Invalid";
    ...
    for (auto const& [code, field] : kSORTED_FIELDS)
    {
        ...
        json::Value innerObj = json::ValueType::ObjectValue;
        ...
        json::Value innerArray = json::ValueType::ArrayValue;
    ...
    defs_[jss::TRANSACTION_RESULTS] = json::ValueType::ObjectValue;
    ...
    defs_[jss::TRANSACTION_TYPES] = json::ValueType::ObjectValue;
    ...
    // populate TxFormats
    defs_[jss::TRANSACTION_FORMATS] = json::ValueType::ObjectValue;

    defs_[jss::TRANSACTION_FORMATS][jss::common] = json::ValueType::ArrayValue;
    auto txCommonFields = std::set<std::string>();
    for (auto const& element : TxFormats::getCommonFields())
    {
        json::Value elementObj = json::ValueType::ObjectValue;
    ...
    for (auto const& format : TxFormats::getInstance())
    {
        ...
        json::Value templateArray = json::ValueType::ArrayValue;
    ...
    defs_[jss::LEDGER_ENTRY_FORMATS] = json::ValueType::ObjectValue;
    defs_[jss::LEDGER_ENTRY_FORMATS][jss::common] = json::ValueType::ArrayValue;
    ...
    defs_[jss::TRANSACTION_FLAGS] = json::ValueType::ObjectValue;
    for (auto const& [name, value] : getAllTxFlags())
    {
        json::Value txObj = json::ValueType::ObjectValue;
    ...
    defs_[jss::LEDGER_ENTRY_FLAGS] = json::ValueType::ObjectValue;
    for (auto const& [name, value] : getAllLedgerFlags())
    {
        json::Value ledgerObj = json::ValueType::ObjectValue;
        for (auto const& [flagName, flagValue] : value)
        {
    ...
    defs_[jss::ACCOUNT_SET_FLAGS] = json::ValueType::ObjectValue;
