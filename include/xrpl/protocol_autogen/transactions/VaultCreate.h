...
public:
    ...
    /**
     * @brief Get sfDealingInterval (SoeOptional)
     * @return The field value, or std::nullopt if not present.
     */
    [[nodiscard]]
    protocol_autogen::Optional<SF_UINT32::type::value_type>
    getDealingInterval() const
    {
        ...
        {
            return this->tx_->at(sfDealingInterval);
        }
        return std::nullopt;
    }
    ...
    {
        return this->tx_->isFieldPresent(sfDealingInterval);
    }

    /**
     * @brief Get sfDealingWindow (SoeOptional)
     * @return The field value, or std::nullopt if not present.
     */
    [[nodiscard]]
    protocol_autogen::Optional<SF_UINT32::type::value_type>
    getDealingWindow() const
    {
        if (hasDealingWindow())
        {
            return this->tx_->at(sfDealingWindow);
        }
        return std::nullopt;
    }
    ...
    {
        return this->tx_->isFieldPresent(sfDealingWindow);
    }
    ...
    /**
     * @brief Get sfAccountingMethod (SoeOptional)
     * @return The field value, or std::nullopt if not present.
     */
    [[nodiscard]]
    protocol_autogen::Optional<SF_UINT8::type::value_type>
    getAccountingMethod() const
    {
        ...
        {
            return this->tx_->at(sfAccountingMethod);
        }
        return std::nullopt;
    }
    ...
    {
        return this->tx_->isFieldPresent(sfAccountingMethod);
    }
};
...
public:
    ...
    /**
     * @brief Set sfDealingInterval (SoeOptional)
     * @return Reference to this builder for method chaining.
     */
    VaultCreateBuilder&
    ...
    /**
     * @brief Set sfDealingWindow (SoeOptional)
     * @return Reference to this builder for method chaining.
     */
    VaultCreateBuilder&
    ...
    /**
     * @brief Set sfAccountingMethod (SoeOptional)
     * @return Reference to this builder for method chaining.
     */
    VaultCreateBuilder&
