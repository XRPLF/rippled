...
public:
    ...
    /**
     * Determines whether the hashed item should be processed for the given peer. Could be an
     * incoming or outgoing message.
     *
     * Items filtered with this function should only be processed for the given peer once. Unlike
     * shouldProcess, it can be processed for other peers.
     */
    bool
