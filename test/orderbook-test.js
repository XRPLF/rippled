...
//          var alice_account = Account.json_rewrite('alice');        
//          assert.strictEqual(true, offers.some(function (obj) {
//             return obj.Account == alice_account;
//            })
//          );
